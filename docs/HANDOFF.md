...
- Public release: [Ceiling 1.5.6](https://github.com/tsouth89/ceiling/releases/tag/v1.5.6). Package / next draft: **1.5.8** (1.5.7 contents plus strip label density and flyout chip hierarchy).
