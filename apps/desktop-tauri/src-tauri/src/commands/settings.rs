...
pub struct SettingsUpdate {
    ...
    pub float_bar_selection_mode: Option<String>,
    pub float_bar_foreground_detection: Option<bool>,
...
impl SettingsUpdate {
    ...
    fn float_bar_patch(&self) -> crate::floatbar::SettingsPatch {
        crate::floatbar::SettingsPatch {
            ...
            selection_mode: self.float_bar_selection_mode.clone(),
            foreground_detection: self.float_bar_foreground_detection,
