...
- **Ceiling-1.5.10-Setup.exe** - standard installer
- **Ceiling-1.5.10-portable.exe** - portable
- **Ceiling-1.5.10-Store-Setup.exe** - Microsoft Store package (WebView2 bundled)
