...
locale_keys! {
    ...
    BrowserCookieSave,
    BrowserCookiePasteRecommended,
    BrowserCookieRecommendedBadge,
    BrowserCookiePasteWhy,
    BrowserCookieStep1Before,
    BrowserCookieStep1After,
    BrowserCookieOpenSite,
    BrowserCookieStep2,
    BrowserCookieStep3Before,
    BrowserCookieStep3Strong,
    BrowserCookieStep3After,
    BrowserCookieStep4Before,
    BrowserCookieStep4After,
    BrowserCookiePasteAreaLabel,
    BrowserCookiePasteClipboard,
    BrowserCookieClipboardDenied,
    BrowserCookieAutoShow,
    BrowserCookieAutoHide,
    BrowserCookieAutoHint,
