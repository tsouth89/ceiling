...
pub(super) struct RawSettings {
    ...
    spend_anomaly_threshold_multiplier: f64,
    #[serde(default)]
...
impl Default for RawSettings {
    fn default() -> Self {
        ...
        Self {
            ...
            spend_anomaly_threshold_multiplier: s.spend_anomaly_threshold_multiplier,
...
impl From<RawSettings> for Settings {
    fn from(raw: RawSettings) -> Self {
        ...
        Settings {
            ...
            spend_anomaly_threshold_multiplier: normalize_spend_anomaly_threshold_multiplier(
                raw.spend_anomaly_threshold_multiplier,
            ),
