...
**v0.33.0** ports upstream CodexBar 0.33.0 fixes to Windows, adds Japanese as a selectable interface language, hardens credentialed provider redirects, improves Claude cost pricing, and avoids false exhausted Doubao quota readings.
...
```powershell
.\scripts\windows-release-build.ps1 -Ref v0.33.0 -SmokeInstall
```
